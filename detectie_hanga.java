...
@Autonomous(name="Cod Hanga DETECTIE", group="Hanga")
//@Disabled
public class detectie_hanga extends LinearOpMode
{
...
*/
    ...
    public void path_stone()
    {
        ...
        else if(pozitie==2)//centru
        {
            ...
            moveToPosition(100, 0.9);
            rotate(-90,power);
            moveToPosition(20,0.9);
            aruncare_cub();
