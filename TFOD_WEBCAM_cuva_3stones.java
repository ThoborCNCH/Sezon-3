...
@Autonomous(name="TFOD_WEBCAM_cuva_3stones", group="Hanga")
//@Disabled
public class TFOD_WEBCAM_cuva_3stones extends LinearOpMode
{
...
*/
    ...
    public void path_stone()
    {
        ...
        else if(pozitie==2)//centru
        {
            ...
            moveToPosition(103, 0.9);
            rotate_placa(-90,power);
            moveToPosition(20,0.5);
            aruncare_cub();
            mutare_placa_orizontal();
            moveToPosition(3,0.9);
            moveToPosition(-50,0.9);
    ...
    public void aruncare_cub()
    {
        ...
        ridicare.setPower(0.8);  
        ridicare2.setPower(-0.8);
        ...
        absortie1.setPower(0);
        absortie2.setPower(0);
        ridicare.setPower(-0.2);
        ridicare2.setPower(0.2);
        sleep(750);
        ridicare.setPower(0);
        ridicare2.setPower(0);
    ...
    private void rotate_placa(int degrees, double power)
    {
