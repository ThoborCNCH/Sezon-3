...
@Autonomous(name="TFOD_WEBCAM_2skys", group="Hanga")
//@Disabled
public class TFOD_WEBCAM_2skys extends LinearOpMode
{
...
*/
    ...
    public void path_stone()
    {
        ...
        else if(pozitie==2)//centru
        {
            ...
            moveToPosition(18, 0.6);
            strafeToPosition(29, 0.6);
            ...
            scuipare_cub();
            rotate(90, power);
            moveToPosition(-72, 0.9); // ma intorc dupa al 2 lea
        ...
        else if(pozitie==3)//dreapta
        {
            ...
            telemetry.update();
            moveToPosition(8, 0.9);
            strafeToPosition(26, 0.6);
            ...
            scuipare_cub();
            rotate(88, power);
            moveToPosition(-80, 1.0); // ma intorc dupa al 2 lea

            //moveToPosition(-10, 0.5);

            strafeToPosition(17, 0.8);
